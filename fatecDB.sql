...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1891377601ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=produtos">`fatec`.`produtos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=usuarios">`fatec`.`usuarios`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=emprestimos">`fatec`.`emprestimos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=alunos">`fatec`.`alunos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=livros">`fatec`.`livros`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6126636e7a35473560784a57777e4350">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="fatec" targettable="usuarios">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM usuarios WHERE login=&#039;admin&#039;  AND senha = &#039;123&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fatec" targettable="usuarios">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `usuarios` WHERE `usuarios`.`id_usuario` = 5</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fatec" targettable="usuarios">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">create table produtos(
    ...
    valor varchar(7)
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="fatec" targettable="produtos">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `produtos`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="fatec" targettable="produtos">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">insert into produtos values (&#039;&#039;,&#039;Revista&#039;,&#039;10,00&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fatec" targettable="produtos">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `produtos` WHERE 1;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="fatec" targettable="produtos">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">insert into produtos values (&#039;&#039;,&#039;Gibi&#039;,&#039;5,00&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="fatec" targettable="produtos">
                            <div class="action_content">
