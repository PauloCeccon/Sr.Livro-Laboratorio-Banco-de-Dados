...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=usuarios">`fatec`.`usuarios`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=produtos">`fatec`.`produtos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=emprestimos">`fatec`.`emprestimos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=alunos">`fatec`.`alunos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=fatec&table=livros">`fatec`.`livros`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
